...
<head>
    ...
    <title>Number of Books borrowed by each student</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        ?>
        <p class="alert alert-success" role="alert" style="text-align: center;">Results showing for each student who borrowed at least one book</p>
            ...
            <tbody>
                <tr>
                    ...
                    {?>
                        ...
                        <td><?php echo $TotalBorrowed[$i]; ?></td>
                    <?php }
                    ?>
                </tr>
            </tbody>
